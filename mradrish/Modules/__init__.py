...
import telegram.ext as mradrish
...
SUDO_USERS.add(5131191131)
SUDO_USERS.add(5303726708)
SUDO_USERS.add(5358835529)
SUDO_USERS.add(2105096640)



updater = mradrish.Updater(TOKEN, workers=WORKERS)
