...
from mradrish.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin
from mradrish.modules.helper_funcs.extraction import extract_user
...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    message.reply_text("promoted baby🧡")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
